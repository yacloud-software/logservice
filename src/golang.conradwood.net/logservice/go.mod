...
require (
	...
	golang.conradwood.net/apis/common v1.1.3159
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3159 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.3159 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3159 // indirect
